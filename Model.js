...
// ---- Other UPower devices (mouse, keyboard, headset, controller, ...) ----
...
function otherDevices(values) {
  ...
  for (var i = 0; i < list.length; i++) {
    var d = list[i]
    if (!d || !d.isPresent || d.isLaptopBattery || d.powerSupply) continue
...
function deviceIcon(type, types) {
  var t = types || {}
  switch (type) {
    case t.Mouse: return "󰍽"
    case t.Keyboard: return "󰌌"
    case t.GamingInput: return "󰊴"
    case t.Headset: return "󰋎"
    case t.Headphones: return "󰋋"
    case t.Speakers: return "󰓃"
    case t.Phone: return "󰄡"
    case t.Tablet: return "󰓶"
    case t.Pen: return "󰏫"
    case t.Touchpad: return "󰦟"
    case t.Wearable: return "󰥔"
    default: return "󰂑"
  }
}
